...
(function() {
   ...
   */
  function isInternalLink(href: any) {
    try {
   ...
   */
  function shouldPrefixPath(path: any) {
   ...
   */
  function hasLangPrefix(path: any) {
   ...
   */
  function setLangPrefix(href: any, lang: any) {
    try {
      const url = new URL(href, location.origin);
   ...
   */
  function updateAllLinks(root: any, lang: any) {
  ...
  function interceptLinkClicks() {
    document.addEventListener('click', function(e) {
      try {
        // @ts-expect-error TS(2339): Property 'closest' does not exist on type 'EventTa... Remove this comment to see the full error message
