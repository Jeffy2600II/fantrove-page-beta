...
function _getMsg(lang: any, key = 'loading') {
  return (
...
const contentLoadingManager = {
  ...
  init() {
    ...
    try {
      // @ts-expect-error TS(2339): Property 'showInstantLoadingOverlay' does not exis... Remove this comment to see the full error message
      window.showInstantLoadingOverlay   = (o: any) => this.show(o);
      // @ts-expect-error TS(2339): Property 'removeInstantLoadingOverlay' does not ex... Remove this comment to see the full error message
  ...
  // Aliases
  showInContent(opts: any) { return this.show(opts); },
  ...
  // ── Utilities ─────────────────────────────────────────
  updateMessage(msg: any) { this._setTexts(msg || null); },
...
try {
  if (typeof window !== 'undefined') {
    ...
    // @ts-expect-error TS(2339): Property 'showInstantLoadingOverlay' does not exis... Remove this comment to see the full error message
    window.showInstantLoadingOverlay   = (o: any) => contentLoadingManager.show(o);
    // @ts-expect-error TS(2339): Property 'removeInstantLoadingOverlay' does not ex... Remove this comment to see the full error message
